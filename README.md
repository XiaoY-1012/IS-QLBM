# Interpolation-supplemented quantum lattice Boltzmann method (IS-QLBM)
Supplementary code for the publication: Xiao Yang, Yang Liming, Dong Hao, Du Yinjie. Interpolation-supplemented quantum lattice Boltzmann method for incompressible flows with non-uniform mesh and curved boundary. Physical Review E. 113(4), 045306, 2026, (https://doi.org/10.1103/gngn-d5dy).
# Abstract
...
# Citation
@article{gngn-d5dy,<br>
  title = {Interpolation-supplemented quantum lattice Boltzmann method for incompressible flows with nonuniform mesh and curved boundary},<br>
  author = {Xiao, Yang and Yang, Liming and Dong, Hao and Du, Yinjie},<br>
  ...
  doi = {10.1103/gngn-d5dy},<br>
  url = {https://link.aps.org/doi/10.1103/gngn-d5dy}<br>
}<br>
